...
void pump_controller_init(void){
	pi_control_state.ki = HC3D_TM_CONFIG_CONTROLLER_KI;
	pi_control_state.kp = HC3D_TM_CONFIG_CONTROLLER_KP;
	pi_control_state.min = HC3D_TM_CONFIG_CONTROLLER_MIN;
	pi_control_state.max = HC3D_TM_CONFIG_CONTROLLER_MAX;
	pi_control_state.shift = HC3D_TM_CONFIG_CONTROLLER_SHIFT;
}
