...
#define HC3D_UNIT_TEST_DRIVER_PWM						2
#define HC3D_UNIT_TEST_LED								3
...
#define HC3D_UNIT_TEST									HC3D_UNIT_TEST_DRIVER_PWM	// Select specific unit test or all unit tests
