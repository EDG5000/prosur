# 1 "../src/libraries/pi_control/pi_control.c"
...
# 1 "../src/libraries/pi_control/pi_control.c"
# 21 "../src/libraries/pi_control/pi_control.c"
...
# 22 "../src/libraries/pi_control/pi_control.c" 2
...
# 23 "../src/libraries/pi_control/pi_control.c" 2
# 32 "../src/libraries/pi_control/pi_control.c"
int pi_control (struct PIControl *p, int e)
{
  
# 34 "../src/libraries/pi_control/pi_control.c" 3 4
 _Bool 
# 34 "../src/libraries/pi_control/pi_control.c"
      int_ok;
  long new_i;
  long u;
  ...
  int_ok = 
# 44 "../src/libraries/pi_control/pi_control.c" 3 4
          1
# 44 "../src/libraries/pi_control/pi_control.c"
              ;
  ...
  if (u > p->max)
  {
    ...
    {
      int_ok = 
# 55 "../src/libraries/pi_control/pi_control.c" 3 4
              0
# 55 "../src/libraries/pi_control/pi_control.c"
                   ;
    }
  }
  ...
  else if (u < p->min)
  {
    ...
    {
      int_ok = 
# 65 "../src/libraries/pi_control/pi_control.c" 3 4
              0
# 65 "../src/libraries/pi_control/pi_control.c"
                   ;
    }
  }
...
# 85 "../src/libraries/pi_control/pi_control.c"
void pi_control_init (struct PIControl *p)
{
  p->i = 0L;
}
