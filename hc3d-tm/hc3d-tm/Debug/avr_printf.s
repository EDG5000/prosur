...
.Ltext0:
	...
	.section	.text.usart_send_byte,"ax",@progbits
.global	usart_send_byte
	.type	usart_send_byte, @function
usart_send_byte:
.LFB2:
	.file 1 "../src/libraries/avr_printf/avr_printf.c"
	.loc 1 23 0
	.cfi_startproc
.LVL0:
	push r28
...
.LVL3:
	...
	.cfi_endproc
.LFE2:
	.size	usart_send_byte, .-usart_send_byte
	.section	.text.usart_get_byte,"ax",@progbits
.global	usart_get_byte
	.type	usart_get_byte, @function
usart_get_byte:
.LFB3:
	.loc 1 32 0
	.cfi_startproc
...
.L5:
	...
	.cfi_endproc
.LFE3:
	.size	usart_get_byte, .-usart_get_byte
	.section	.text.avr_printf_init,"ax",@progbits
.global	avr_printf_init
	.type	avr_printf_init, @function
avr_printf_init:
.LFB1:
	.loc 1 15 0
	.cfi_startproc
...
.L__stack_usage = 0
	...
	.cfi_endproc
.LFE1:
	.size	avr_printf_init, .-avr_printf_init
.global	uart_input
	.section	.data.uart_input,"aw",@progbits
...
.Ldebug_macro0:
	...
	.uleb128 0x28
	.long	.LASF1479
	.file 14 "c:\\program files (x86)\\atmel\\studio\\7.0\\toolchain\\avr8\\avr8-gnu-toolchain\\lib\\gcc\\avr\\5.4.0\\include\\stdarg.h"
	.byte	0x3
	.uleb128 0x2d
	.uleb128 0xe
	.byte	0x7
	...
	.byte	0x7
	.long	.Ldebug_macro12
	.file 15 "c:\\program files (x86)\\atmel\\studio\\7.0\\toolchain\\avr8\\avr8-gnu-toolchain\\lib\\gcc\\avr\\5.4.0\\include\\stddef.h"
	.byte	0x3
	.uleb128 0x32
	.uleb128 0xf
	.byte	0x7
	...
	.long	.Ldebug_macro14
	.byte	0x4
	.file 16 "../src/libraries/avr_printf/avr_printf.h"
	.byte	0x3
	.uleb128 0x4
	.uleb128 0x10
	.byte	0x4
...
.LASF1404:
	.string	"PB2 PORTB2"
.LASF1552:
	.string	"BAUD_PRESCALE (F_CPU/16/BAUD_RATE-1)"
.LASF414:
...
.LASF736:
	.string	"PCIF0 0"
.LASF1576:
	.string	"../src/libraries/avr_printf/avr_printf.c"
.LASF691:
	.string	"PORTC3 3"
.LASF1209:
	.string	"TWD3 3"
