...
.Ltext0:
	...
	.section	.text.pump_controller_init,"ax",@progbits
.global	pump_controller_init
	.type	pump_controller_init, @function
pump_controller_init:
.LFB0:
	.file 1 "../src/business_logic/pump_controller.c"
	.loc 1 17 0
	.cfi_startproc
/* prologue: function */
/* frame size = 0 */
...
.L__stack_usage = 0
	.loc 1 18 0
	ldi r30,lo8(pi_control_state)
	ldi r31,hi8(pi_control_state)
	ldi r24,lo8(1)
	ldi r25,0
	std Z+3,r25
	std Z+2,r24
	...
	.cfi_endproc
.LFE0:
	.size	pump_controller_init, .-pump_controller_init
	.section	.text.pump_controller_tick,"ax",@progbits
.global	pump_controller_tick
	.type	pump_controller_tick, @function
...
.LVL4:
	.loc 1 39 0
	ldi r24,lo8(pi_control_state)
	ldi r25,hi8(pi_control_state)
.LVL5:
	call pi_control
.LVL6:
	.loc 1 42 0
	call driver_pwm_set_pwm
.LVL7:
	ret
	.cfi_endproc
.LFE1:
	.size	pump_controller_tick, .-pump_controller_tick
	.comm	sensor_last_valid_temperature,16,1
	.comm	pi_control_state,13,1
	.text
.Letext0:
	.file 2 "../src/libraries/pi_control/pi_control.h"
	.file 3 "../src/drivers/driver_pwm.h"
...
.Ldebug_macro0:
	...
	.long	.Ldebug_macro11
	.byte	0x4
	.file 16 "../src/business_logic/pump_controller.h"
	.byte	0x3
	.uleb128 0x9
	.uleb128 0x10
	.byte	0x4
	...
	.uleb128 0x2
	.byte	0x4
	.file 17 "../src/business_logic/temp_watchdog.h"
	.byte	0x3
	.uleb128 0xc
	.uleb128 0x11
	.file 18 "c:\\program files (x86)\\atmel\\studio\\7.0\\toolchain\\avr8\\avr8-gnu-toolchain\\lib\\gcc\\avr\\5.4.0\\include\\stdbool.h"
	.byte	0x3
	.uleb128 0xb
	.uleb128 0x12
	.byte	0x7
	...
	.uleb128 0x3
	.byte	0x4
	.file 19 "../src/drivers/driver_tach.h"
	.byte	0x3
	.uleb128 0xf
	.uleb128 0x13
	.byte	0x4
...
.LASF698:
	.string	"PIND2 2"
.LASF1540:
	.string	"../src/business_logic/pump_controller.c"
.LASF939:
	.string	"CAL3 3"
.LASF45:
