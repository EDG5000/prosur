...
.Ltext0:
	...
	.section	.text.check_safety_state,"ax",@progbits
	.type	check_safety_state, @function
check_safety_state:
.LFB2:
	.file 1 "../src/business_logic/temp_watchdog.c"
	.loc 1 62 0
	.cfi_startproc
.LVL0:
/* prologue: function */
...
.L__stack_usage = 0
	...
	lsl r30
	rol r31
	subi r30,lo8(-(sensor_safety_limit))
	sbci r31,hi8(-(sensor_safety_limit))
	ld r18,Z
	ldd r19,Z+1
	cp r18,r24
	cpc r19,r25
...
.LVL5:
	...
	.cfi_endproc
.LFE2:
	.size	check_safety_state, .-check_safety_state
	.section	.text.temp_watchdog_init,"ax",@progbits
.global	temp_watchdog_init
	.type	temp_watchdog_init, @function
temp_watchdog_init:
.LFB1:
	.loc 1 52 0
	.cfi_startproc
...
.L__stack_usage = 0
	.loc 1 54 0
	ldi r30,lo8(sensor_safety_limit)
	ldi r31,hi8(sensor_safety_limit)
	ldi r24,lo8(65)
	ldi r25,0
	std Z+1,r25
	st Z,r24
	...
	.cfi_endproc
.LFE1:
	.size	temp_watchdog_init, .-temp_watchdog_init
...
.LC1:
	.string	"%i"
.LC2:
	.string	"has state UNSAFE."
	.section	.text.temp_watchdog_tick,"ax",@progbits
.global	temp_watchdog_tick
	.type	temp_watchdog_tick, @function
temp_watchdog_tick:
.LFB3:
	.loc 1 74 0
	.cfi_startproc
...
.LBB4:
	...
	lsl r30
	rol r31
	subi r30,lo8(-(last_temperatures))
	sbci r31,hi8(-(last_temperatures))
	mov r22,r28
	ld r24,Z
	ldd r25,Z+1
	call check_safety_state
.LVL8:
	mov r13,r24
.LVL9:
	.loc 1 80 0
...
.LVL11:
	movw r30,r28
	subi r30,lo8(-(sensor_safety_state))
	sbci r31,hi8(-(sensor_safety_state))
	st Z,r24
	.loc 1 87 0
	rjmp .L9
.LVL12:
...
.L18:
	...
	lsl r30
	rol r31
	subi r30,lo8(-(sensor_last_valid_temperature))
	sbci r31,hi8(-(sensor_last_valid_temperature))
	std Z+1,r25
	st Z,r24
.L19:
...
.LVL29:
	...
	.cfi_endproc
.LFE3:
	.size	temp_watchdog_tick, .-temp_watchdog_tick
	.comm	sensor_last_valid_temperature,16,1
	.comm	sensor_safety_limit,16,1
	.comm	sensor_safety_state,8,1
	.text
.Letext0:
	.file 2 "c:\\program files (x86)\\atmel\\studio\\7.0\\toolchain\\avr8\\avr8-gnu-toolchain\\avr\\include\\stdint.h"
	.file 3 "../src/business_logic/failsafe.h"
	.file 4 "c:\\program files (x86)\\atmel\\studio\\7.0\\toolchain\\avr8\\avr8-gnu-toolchain\\avr\\include\\stdio.h"
...
.Ldebug_info0:
	...
	.byte	0x5
	.byte	0x3
	.long	sensor_last_valid_temperature
	.uleb128 0x18
	.byte	0x1
	.byte	0x1
	.long	.LASF1620
...
.Ldebug_macro0:
	...
	.uleb128 0x6
	.long	.LASF439
	.file 5 "c:\\program files (x86)\\atmel\\studio\\7.0\\toolchain\\avr8\\avr8-gnu-toolchain\\lib\\gcc\\avr\\5.4.0\\include\\stdint.h"
	.byte	0x3
	.uleb128 0x16
	.uleb128 0x5
	.byte	0x3
	...
	.long	.Ldebug_macro4
	.byte	0x4
	.file 10 "C:\\Program Files (x86)\\Atmel\\Studio\\7.0\\Packs\\Atmel\\ATmega_DFP\\1.5.362\\include/avr/iom328p.h"
	.byte	0x3
	.uleb128 0x110
	.uleb128 0xa
	.byte	0x7
	...
	.long	.Ldebug_macro11
	.byte	0x4
	.file 16 "c:\\program files (x86)\\atmel\\studio\\7.0\\toolchain\\avr8\\avr8-gnu-toolchain\\lib\\gcc\\avr\\5.4.0\\include\\stdbool.h"
	.byte	0x3
	.uleb128 0x18
	.uleb128 0x10
	.byte	0x7
	...
	.uleb128 0x28
	.long	.LASF1522
	.file 17 "c:\\program files (x86)\\atmel\\studio\\7.0\\toolchain\\avr8\\avr8-gnu-toolchain\\lib\\gcc\\avr\\5.4.0\\include\\stdarg.h"
	.byte	0x3
	.uleb128 0x2d
	.uleb128 0x11
	.byte	0x7
	...
	.long	.Ldebug_macro16
	.byte	0x4
	.file 19 "../src/business_logic/temp_watchdog.h"
	.byte	0x3
	.uleb128 0x1b
	.uleb128 0x13
	.byte	0x4
	...
	.uleb128 0x3
	.byte	0x4
	.file 20 "../src/business_logic/data_reader.h"
	.byte	0x3
	.uleb128 0x1d
	.uleb128 0x14
	.byte	0x4
...
.LASF1612:
	.string	"current_sample_safety_state"
.LASF600:
...
.LASF1613:
	.string	"last_sample_safety_state"
.LASF1576:
...
.LASF915:
	.string	"CLKPS1 1"
.LASF1619:
	.string	"sensor_last_valid_temperature"
.LASF1127:
	.string	"OCR1BL6 6"
.LASF166:
...
.LASF1623:
	.string	"../src/business_logic/temp_watchdog.c"
.LASF109:
