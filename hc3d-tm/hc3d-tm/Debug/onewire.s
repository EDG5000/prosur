...
.Ltext0:
	...
	.section	.text.onewireInit,"ax",@progbits
.global	onewireInit
	.type	onewireInit, @function
onewireInit:
.LFB6:
	.file 1 "../src/libraries/avr-ds80b20/onewire.c"
	.loc 1 22 0
	.cfi_startproc
.LVL0:
	push r28
...
/* epilogue start */
	...
	.cfi_endproc
.LFE6:
	.size	onewireInit, .-onewireInit
	.section	.text.onewireWriteBit,"ax",@progbits
.global	onewireWriteBit
	.type	onewireWriteBit, @function
onewireWriteBit:
.LFB7:
	.loc 1 56 0
	.cfi_startproc
...
.LVL24:
	...
	.cfi_endproc
.LFE7:
	.size	onewireWriteBit, .-onewireWriteBit
	.section	.text.onewireWrite,"ax",@progbits
.global	onewireWrite
	.type	onewireWrite, @function
onewireWrite:
.LFB8:
	.loc 1 82 0
	.cfi_startproc
...
.LVL36:
	...
	.cfi_endproc
.LFE8:
	.size	onewireWrite, .-onewireWrite
	.section	.text.onewireReadBit,"ax",@progbits
.global	onewireReadBit
	.type	onewireReadBit, @function
onewireReadBit:
.LFB9:
	.loc 1 98 0
	.cfi_startproc
...
.LBE44:
	...
	.cfi_endproc
.LFE9:
	.size	onewireReadBit, .-onewireReadBit
	.section	.text.onewireRead,"ax",@progbits
.global	onewireRead
	.type	onewireRead, @function
onewireRead:
.LFB10:
	.loc 1 121 0
	.cfi_startproc
...
.Ldebug_macro0:
	...
	.byte	0x4
	.byte	0x4
	.file 14 "c:\\program files (x86)\\atmel\\studio\\7.0\\toolchain\\avr8\\avr8-gnu-toolchain\\avr\\include\\avr\\interrupt.h"
	.byte	0x3
	.uleb128 0xf
	.uleb128 0xe
	.byte	0x7
	...
	.byte	0x4
	.byte	0x4
	.file 17 "../src/libraries/avr-ds80b20/onewire.h"
	.byte	0x3
	.uleb128 0x12
	.uleb128 0x11
	.byte	0x7
...
.LASF1578:
	.string	"../src/libraries/avr-ds80b20/onewire.c"
.LASF221:
