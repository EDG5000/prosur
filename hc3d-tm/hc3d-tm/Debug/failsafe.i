# 1 "../src/business_logic/failsafe.c"
...
# 9 "../src/business_logic/failsafe.c" 2
...
#define SEEK_CUR 1
#define SEEK_END 2
# 10 "../src/business_logic/failsafe.c" 2
...
# 11 "../src/business_logic/failsafe.c" 2

void failsafe_trigger(void){
 driver_relay_set(
# 13 "../src/business_logic/failsafe.c" 3 4
                 0
# 13 "../src/business_logic/failsafe.c"
                      );
