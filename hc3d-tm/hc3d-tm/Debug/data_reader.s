...
.Ltext0:
	...
	.section	.text.data_reader_tick,"ax",@progbits
.global	data_reader_tick
	.type	data_reader_tick, @function
data_reader_tick:
.LFB0:
	.file 1 "../src/business_logic/data_reader.c"
	.loc 1 22 0
	.cfi_startproc
	push r28
.LCFI0:
...
.LBE5:
	...
	.cfi_endproc
.LFE0:
	.size	data_reader_tick, .-data_reader_tick
	.comm	last_temperatures,160,1
	.text
.Letext0:
	.file 2 "c:\\program files (x86)\\atmel\\studio\\7.0\\toolchain\\avr8\\avr8-gnu-toolchain\\avr\\include\\stdint.h"
	.file 3 "../src/drivers/driver_temp.h"
...
.Ldebug_macro0:
	...
	.uleb128 0x6
	.long	.LASF439
	.file 4 "../src/business_logic/data_reader.h"
	.byte	0x3
	.uleb128 0xb
	.uleb128 0x4
...
.LASF749:
	.string	"GPIOR03 3"
.LASF1529:
	.string	"../src/business_logic/data_reader.c"
.LASF833:
	.string	"GPIOR13 3"
.LASF9:
